...
import com.meghamlabs.newsapp.databinding.FragmentNewsBinding
...
class NewsFragment : Fragment() {
    ...
    private fun viewNewsList() {
        ...
        viewModel.newsHeadLines.observe(viewLifecycleOwner,{response->
            when(response){
                is com.meghamlabs.newsapp.data.util.Resource.Success->{
                ...
                is com.meghamlabs.newsapp.data.util.Resource.Error->{
                    hideProgressBar()
                ...
                is com.meghamlabs.newsapp.data.util.Resource.Loading->{
                    showProgressBar()
                }
